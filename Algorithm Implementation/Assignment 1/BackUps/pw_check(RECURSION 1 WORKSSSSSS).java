...
public class pw_check {
	...
	public static void main(String[] args){
		...
		if(args.length == 1 && (args[0].equals("-g") || args[0].equals("-G"))){	// Okay so we are going to need to read-in the provided dictionary.				
			...
			System.out.println("\nBAD DLB WORD COUNT: " + allBad.getWordCount() + "\n");
	...
	public void findPossible(char[] pattern, int patternIndex, String prefix, DLBTrie badDLBTrie, PrintWriter goodPasswordsOut){
		if(patternIndex == 4){				//If we are on our last index
			System.out.println("HEY WE MADE IT TO A FINAL RECURSIVE CALL"); //TEST
	...
	public boolean lookupPossible(String prefixToCheck, DLBTrie badTrie){
		...
		if(prefixLength == 1){
			...
			System.out.println("prefixLength 1");	//TEST
			System.out.println(prefixToCheck);
		}else if(prefixLength == 2){
			result = lookupPossible2(prefixToCheck, prefixLength, badTrie);
			System.out.println("HEY WE MADE IT TO prefixLength 2");	//TEST
			System.out.println(prefixToCheck);
		}else if(prefixLength == 3){
			result = lookupPossible3(prefixToCheck, prefixLength, badTrie);
			System.out.println("HEY WE MADE IT TO prefixLength 3");	//TEST
			System.out.println(prefixToCheck);
		}else if(prefixLength == 4){
			result = lookupPossible4(prefixToCheck, prefixLength, badTrie);
			System.out.println("HEY WE MADE IT TO prefixLength 4");	//TEST
			System.out.println(prefixToCheck);
		}else if(prefixLength == 5){
			result = lookupPossible5(prefixToCheck, prefixLength, badTrie);
			System.out.println("HEY WE MADE IT TO prefixLength 5");	//TEST
			System.out.println(prefixToCheck);
		}
	...
	public boolean lookupPossible2(String prefixToLookup, int length, DLBTrie badPasswordTrie){	//COMPLETE IN THEORY
		boolean result = true;
		StringBuilder temp = new StringBuilder(prefixToLookup);
		DLBNode current = badPasswordTrie.getRoot();
	...
	public boolean lookupPossible3(String prefixToLookup, int length, DLBTrie badPasswordTrie){	//COMPLETE IN THEORY
		boolean result = true;
		StringBuilder temp = new StringBuilder(prefixToLookup);
		DLBNode current = badPasswordTrie.getRoot();
		boolean flag = true;
	...
	public boolean lookupPossible4(String prefixToLookup, int length, DLBTrie badPasswordTrie){	//COMPLETE IN THEORY
		boolean result = true;
		StringBuilder temp = new StringBuilder(prefixToLookup);
		DLBNode current = badPasswordTrie.getRoot();
		boolean flag = true;
	...
	public boolean lookupPossible5(String prefixToLookup, int length, DLBTrie badPasswordTrie){	//COMPLETE IN THEORY
		boolean result = true;
		StringBuilder temp = new StringBuilder(prefixToLookup);
		DLBNode current = badPasswordTrie.getRoot();
		boolean flag = true;
