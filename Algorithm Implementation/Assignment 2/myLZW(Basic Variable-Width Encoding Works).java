...
public class myLZW {
    ...
    public static void compress() { 
        ...
        while (input.length() > 0) {	//Iterate through the file
			...
			if(t<input.length() && code >= L && W < 16){	//Upgrade our codeword length [We are about to add to 512 [so 512 will be filled with a w+1 bitlength codeword]]
				W = W+1;
    ...
    public static void expand() {
        ...
        while (true) {
		   ...
		   if(i >= L && W < 16){		//When i = 512/4096, so when we are about to store in array index 512 [512 is holding null at the end of this if/statement]
