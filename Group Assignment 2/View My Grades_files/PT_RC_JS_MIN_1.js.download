...
else if(key == 38) 
{
 ...
 else if(!this.bInitExpandedView || (this.bInitExpandedView && !this.bInitialServiceRequest))
 {
 RCArea.onload = function()
 {
 ...
 RCArea.onload = function()
 {
 var focused = document.getElementById('ptifrmtgtframe'); if(typeof(focused) != 'undefined' && focused != null )
 focused.focus(); }
 }
 }
 if (RCArea.src == url)
