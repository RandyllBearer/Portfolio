...
encodeRegisterISLinked:
	...
	beq $t4, 9, encodeIST9
encodeIST0:
	addi $t1, $t1, 0x01000000	### Add the register hexadecimal value to our 32-bit string
	jr $ra
encodeIST1:
...
encodeRegisterID:	### I-TYPE Destination Register
	...
	beq $s3, 9, encodeIDT9
encodeIDT0:
	addi $t1, $t1, 0x00080000	### add the register hexadecimal value to our 32-bit string
	jr $ra
encodeIDT1:
