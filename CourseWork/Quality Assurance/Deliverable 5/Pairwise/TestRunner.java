...
public class TestRunner {
	...
	// Added class Del3Test, which was created for this assignment
	// Alterations to the remainder of the template were not necessary
	classesToTest.add(Del5Test.class);
