...
def move_train(self):                         ### Future-me, I'm sorry.
    ...
    if int(move_specification) > int(last_train) or int(move_specification) < 0:
        print("\nSorry, cannot compute user command.")
    ...
    if train_list.index(move_specification) == 4:      ### Tests to remove trains in block 4
        ...
        train_list[new_train] = str(move_specification)         ### move_specification because train # staying the same
        ...
        print("\nSorry, cannot compute command.")     # You dun goofed
...
print("\n      - Create       [Will create a train at block 0]")
